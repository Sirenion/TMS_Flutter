...
import 'package:homework/pages/homework_2_page.dart';
      ...
      GoRoute(
        ...
        routes: [
          ...
          ShellRoute(
            ...
            routes: [
              GoRoute(
                name: appRoutes.home.homework2.routeName,
                path: appRoutes.home.homework2.relativePath,
                builder: (context, state) {
                  return const Homework2Page();
                },
              ),
            ],
          ),
